  ...
  <UCard>
    <div>
      ...
      <div class="flex items-center justify-between">
        <p class="text-sm text-gray-500 mt-1">{{ props.data.apresentacao }}</p>
        <UBadge
    ...
    <div class="space-y-1">
      ...
      >
        <UIcon name="i-heroicons-beaker" class="text-gray-400 flex-shrink-0" />
        <p class="text-gray-600 truncate">{{ props.data.principio_ativo }}</p>
      </div>
      <div v-if="props.data.cod_barras" class="flex items-center text-sm gap-2">
        <UIcon name="i-heroicons-bars-4" class="text-gray-400 flex-shrink-0" />
        <p class="text-gray-600 font-mono">{{ props.data.cod_barras }}</p>
      </div>
      <div
